<div align="center">
  <img src="https://media.giphy.com/media/3o7btPCcdNniyf0ArS/giphy.gif" 
       ...
       alt="AI & Innovation Animation">
</div>
  <div style="background: linear-gradient(to bottom, rgba(0,0,0,0.25) 0%, rgba(0,0,0,0.80) 100%);
...
### 📊 Статистика
<!-- Сейчас stats не грузятся из-за rate limit / паузы на vercel.app (проблема массовая в 2026) -->

<!-- Вариант 1 — самый простой и надёжный сейчас: закомментировал, чтобы не было пустоты -->
<!-- Если хочешь вернуть — лучше форкни репозиторий и разверни у себя на Vercel с PAT -->
...
<!-- Альтернатива: можно использовать streak-stats или просто бейдж просмотров -->
![Profile Views](https://komarev.com/ghpvc/?username=gricenkoa444-web&style=for-the-badge&color=brightgreen)
